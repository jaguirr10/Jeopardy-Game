...
$(document).ready(function(){
    $('.hundred-6').click(function(){
        //();
    $('.hundred-6').empty();
    while(!sqlQ1){
        var sqlQ1 = prompt(sql.Q1);
        if (sqlQ1 === null || sqlQ1 === false || sqlQ1 === ""){
            sqlQ1 = prompt("You must enter your answer."); 
        }
        if(sqlQ1.toLowerCase() === sql.A1) {
            winNoise.play();
            alert("correct!!!"); 
            playerScore += 100;
            document.getElementById('score').innerHTML = playerScore;  
...
$(document).ready(function(){
    $('.two-hundred-6').click(function(){
        //();
    $('.two-hundred-6').empty();
    while(!sqlQ2){
        var sqlQ2 = prompt(sql.Q2);
        if (sqlQ2 === null || sqlQ2 === false || sqlQ2 === ""){
            sqlQ2 = prompt("You must enter your answer."); 
        }
        if(sqlQ2.toLowerCase() === sql.A1) {
            winNoise.play();
            alert("correct!!!"); 
            playerScore += 200;
            document.getElementById('score').innerHTML = playerScore;  
...
$(document).ready(function(){
    $('.three-hundred-6').click(function(){
        //();
    $('.three-hundred-6').empty();
    while(!sqlQ3){
        var sqlQ3 = prompt(sql.Q3);
        if (sqlQ3 === null || sqlQ3 === false || sqlQ3 === ""){
            sqlQ3 = prompt("You must enter your answer."); 
        }
        if(cQ3.toLowerCase() === sql.A1) {
            winNoise.play();
            alert("correct!!!"); 
            playerScore += 300;
            document.getElementById('score').innerHTML = playerScore;  
...
$(document).ready(function(){
    $('.four-hundred-6').click(function(){
        //();
    $('.four-hundred-6').empty();
    while(!sqlQ4){
        var sqlQ4 = prompt(sql.Q4);
        if (sqlQ4 === null || sqlQ4 === false || sqlQ4 === ""){
            sqlQ4 = prompt("You must enter your answer."); 
        }
        if(sqlQ4.toLowerCase() === sql.A4) {
            winNoise.play();
            alert("correct!!!"); 
            playerScore += 400;
            document.getElementById('score').innerHTML = playerScore;  
...
$(document).ready(function(){
    $('.five-hundred-6').click(function(){
        //();
    $('.five-hundred-6').empty();
    while(!sqlQ5)
        var sqlQ5 = prompt(sql.Q5);
        if (sqlQ5 === null || sqlQ5 === false || sqlQ5 === ""){
            sqlQ5 = prompt("You must enter your answer."); 
        }
        if(sqlQ5.toLowerCase() === sql.A5) {
            winNoise.play();
            alert("correct!!!"); 
            playerScore += 500;
            document.getElementById('score').innerHTML = playerScore;  
